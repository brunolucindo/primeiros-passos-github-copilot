...
activities = {
   ...
   "Vôlei": {
      "description": "Aulas e campeonatos de vôlei",
   ...
   # Artísticas
   "Teatro": {
      "description": "Oficina de teatro e apresentações semestrais",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    if len(activity["participants"]) >= activity["max_participants"]:
        raise HTTPException(status_code=400, detail=f"{activity_name} está cheio. Máximo de participantes atingido.")
